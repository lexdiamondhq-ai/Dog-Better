  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <Screen scrollRef={scrollRef} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: insets.bottom + 96 }}>
        <ScreenHeader eyebrow="Pack" title="Moment" onBack={() => router.back()} large={false} />
        {post ? <PostCard post={post} onLike={like} onOpen={() => {}} /> : null}
      ...
      <View style={[styles.composer, { paddingBottom: insets.bottom + space.sm, backgroundColor: t.bg, borderTopColor: t.border }]}>
        <View style={{ flex: 1 }}>
          <Field placeholder="Add a comment" value={body} onChangeText={setBody} maxLength={280} returnKeyType="send" onSubmitEditing={send} />
        </View>
