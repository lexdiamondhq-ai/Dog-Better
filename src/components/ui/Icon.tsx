...
export const ICONS = {
  ...
  track: { ios: 'square.and.pencil', android: 'edit_note' },
  learn: { ios: 'book.fill', android: 'menu_book' },
  careTeam: { ios: 'person.2.fill', android: 'group' },
  care: { ios: 'heart.text.square.fill', android: 'stethoscope' },
  places: { ios: 'map.fill', android: 'map' },
  vault: { ios: 'lock.doc.fill', android: 'folder_shared' },
  lock: { ios: 'lock.fill', android: 'lock' },
  document: { ios: 'doc.text.fill', android: 'description' },
  docScan: { ios: 'doc.viewfinder', android: 'document_scanner' },
  video: { ios: 'video.fill', android: 'videocam' },
  stool: { ios: 'circle.hexagongrid.fill', android: 'grain' },
  mood: { ios: 'face.smiling', android: 'mood' },
  energy: { ios: 'bolt.heart.fill', android: 'monitor_heart' },
  ...
  apple: { ios: 'apple.logo', android: 'ios' },
  mail: { ios: 'envelope.fill', android: 'mail' },
  key: { ios: 'key.fill', android: 'key' },
  toy: { ios: 'tennisball.fill', android: 'sports_baseball' },
  link: { ios: 'link', android: 'link' },
  detective: { ios: 'magnifyingglass.circle.fill', android: 'search_insights' },
